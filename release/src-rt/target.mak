...
export RT-AC66U := IPV6SUPP=y HTTPS=y MIPS32=r2 BCM57=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=n \
                   MEDIASRV=n MODEM=n MODEMPIN=n PARENTAL2=n ACCEL_PPTPD=y PRINTER=n WEBDAV=n CLOUDSYNC=n \
                   ...
                   SSH=y BOOTLZMA=y DUAL_TRX=n DISK_MONITOR=y OPTIMIZE_XBOX=y NFS=n USER_LOW_RSSI=y SNMPD=n \
                   TIMEMACHINE=n MDNS=n VPNC=y JFFS2LOG=n DUMP_OOPS_MSG=y DEBUGFS=n DROPBOXCLIENT=n TEMPROOTFS=y \
                   FTPCLIENT=n SAMBACLIENT=n SWEBDAVCLIENT=n \
                   TFAT=n HFS="none" NTFS="none" IPSEC=y REPEATER=n DUALWAN=n YANDEXDNS=n DNSFILTER=y SAMBA36=n \
                   NO_SAMBA=y STRACE=y TCPDUMP=y
